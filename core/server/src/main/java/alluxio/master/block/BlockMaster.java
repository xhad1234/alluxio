...
public final class BlockMaster extends AbstractMaster implements ContainerIdGenerable {
  ...
  private static final IndexDefinition<MasterWorkerInfo> ID_INDEX_DEFINITION =
  ...
  private static final IndexDefinition<MasterWorkerInfo> ADDRESS_INDEX_DEFINITION =
      new IndexDefinition<MasterWorkerInfo>(true) {
        @Override
        public Object getFieldValue(MasterWorkerInfo o) {
  ...
  private final IndexedSet<MasterWorkerInfo> mWorkers =
      new IndexedSet<>(ID_INDEX_DEFINITION, ADDRESS_INDEX_DEFINITION);
  ...
  public void removeBlocks(List<Long> blockIds, boolean delete) {
    for (long blockId : blockIds) {
      ...
      for (long workerId : workerIds) {
        MasterWorkerInfo worker = mWorkers.getFirstByField(ID_INDEX_DEFINITION, workerId);
        if (worker != null) {
          synchronized (worker) {
  ...
  public long getWorkerId(WorkerNetAddress workerNetAddress) {
    ...
    MasterWorkerInfo existingWorker = mWorkers.getFirstByField(ADDRESS_INDEX_DEFINITION, workerNetAddress);
    ...
    MasterWorkerInfo lostWorker = mLostWorkers.getFirstByField(ADDRESS_INDEX_DEFINITION, workerNetAddress);
    if (lostWorker != null) {
  ...
  private BlockInfo generateBlockInfo(MasterBlockInfo masterBlockInfo) {
    ...
    for (MasterBlockLocation masterBlockLocation : blockLocations) {
      MasterWorkerInfo workerInfo =
          mWorkers.getFirstByField(ID_INDEX_DEFINITION, masterBlockLocation.getWorkerId());
      if (workerInfo != null) {
